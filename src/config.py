...
FINGER_CURLS_PER_HAND = 5
PRIMARY_CURL_IDX = RIGHT_WRIST_IDX + 2       # 198
LEFT_CURL_IDX = PRIMARY_CURL_IDX + FINGER_CURLS_PER_HAND   # 203
RIGHT_CURL_IDX = LEFT_CURL_IDX + FINGER_CURLS_PER_HAND     # 208
FEATURES_PER_FRAME = RIGHT_CURL_IDX + FINGER_CURLS_PER_HAND  # 213
